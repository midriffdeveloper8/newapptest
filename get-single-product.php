...
$response = $client->request(
	'GET', 
	"https://{$store}/admin/products/7962453637.json",
	[
		'query' => [
			'fields' => 'id,images,title,variants,body_html',
...
$template = $twig->loadTemplate('single-product.html');
echo $template->render(['product' => $result['product']]);
